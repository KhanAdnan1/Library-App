...
//'https://newclgsercer.onrender.com/images'
  void fetchImageBase64Data() async {
    try {
      // Make the HTTP GET request to your server
      final response =
          await http.get(Uri.parse('http://192.168.198.107:5000/images'));
  ...
  Future<List<String>> fetchNoticeData() async {
    final response =
        await http.get(Uri.parse('http://192.168.198.107:5000/notices'));
    ...
    return Scaffold(
        ...
        body: ListView(
          children: [
            ...
            //
            //   child: IconButton(
            //     icon: const Icon(Icons.lens_blur_sharp),
            //     iconSize: 50,
            //     onPressed: () =>Navigator.push(context,MaterialPageRoute(builder: (context)=> Ocr()),
            //
            //   ),
            //
            // ),
            ...
            Stack(
              ...
              children: [
                Positioned(
                  // Adjust the right value as needed for the desired spacing from the right side
                  child: Card(
                    elevation: 3,
                    shadowColor: Colors.blue,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(60.0), // Adjust border radius to make it circular
                    ),
                    child: InkWell(
                      onTap: () {
                        // Handle button tap
                        Navigator.push(context, MaterialPageRoute(builder: (context) => Ocr()));

                      },
                      borderRadius: BorderRadius.circular(60.0), // Same as border radius above
                      child: Container(

                        width: 50.0, // Width of the circular card
                        height: 50.0, // Height of the circular card
